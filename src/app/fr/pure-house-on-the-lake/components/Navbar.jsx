    ...
    >
      <div className="w-full flex justify-between items-center mx-auto px-5 lg:px-14">
        ...
        <ul className="w-full lg:w-[65%] lg:flex hidden justify-end items-center gap-10 uppercase text-[12px] leading-[20.4px] font-montserrat font-normal tracking-widest">
          ...
          <li className="hover:opacity-80 transition-all duration-200 ease-in-out">
            <Link href="/fr/pure-house-on-the-lake/about">{"À propos"}</Link>
          </li>
          <li className="hover:opacity-80 transition-all duration-200 ease-in-out">
            <Link href="/fr/pure-house-on-the-lake/events">{"Événements"}</Link>
          </li>
          <li className="hover:opacity-80 transition-all duration-200 ease-in-out">
        ...
        <div className="w-full lg:w-[20%] lg:flex hidden justify-center gap-3 items-center  text-white cursor-pointer">
          ...
          >
            ...
            >
              <span className="text-[12px]">{"FR"}</span>
              <div className="">
        ...
        >
          <div className="fixed top-0 left-0 z-10 w-full h-screen bg-lake_mobile flex flex-col items-left justify-start gap-16 py-6 px-6 uppercase">
            ...
            >
              ...
              <li className="hover:opacity-80 transition-all duration-200 ease-in-out">
                <Link href="/fr/pure-house-on-the-lake/about">
                  {"À propos"}
                </Link>
              </li>
              <li className="hover:opacity-80 transition-all duration-200 ease-in-out">
                <Link href="/fr/pure-house-on-the-lake/events">
                  {"Événements"}
                </Link>
              </li>
              <li className="hover:opacity-80 transition-all duration-200 ease-in-out">
