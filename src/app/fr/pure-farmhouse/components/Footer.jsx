    ...
    <footer className="bg-riad_background text-riad_primary px-6 py-20">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-around items-center md:items-center space-y-10 md:space-y-0">
        ...
        <div className="w-full font-montserrat md:w-[60%] flex flex-col md:flex-row justify-between items-center md:items-start space-y-10 md:space-y-0">
          {/* Left Section */}
          <div className="flex flex-col justify-center items-center md:items-start space-y-7 text-[14px] lg:text-[15px] leading-[12px] text-riad_primary">
            <span>
          ...
          {/* Center Section */}
          <div className="flex flex-col justify-center items-center md:items-start space-y-7 text-[13px] lg:text-[15px] leading-[12px] text-riad_primary">
            <span>
              <Link href="/fr/pure-farmhouse">{"Farm House"}</Link>
            </span>
            <span>
              <Link href="/fr/pure-farmhouse/gallery">{"Galerie"}</Link>
            </span>
            <span>
