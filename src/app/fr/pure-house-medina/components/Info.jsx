      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 lg:gap-8 items-center">
        ...
        <div className="w-full h-full space-y-4">
          ...
          <p className="text-riad_primary text-[14px] leading-[21px] font-light">
            ...
            <br />
            {
              "Toutes les chambres de ce riad comprennent une terrasse. Leur salle de bains privative est pourvue d'une douche et d'un sèche-cheveux.  Le linge de lit et les serviettes sont fournis."
            }
            <br />
            <br />
            {
              "Un petit-déjeuner continental, italien et végétarien est servi tous les jours."
            }
            <br />
            <br />
            {
